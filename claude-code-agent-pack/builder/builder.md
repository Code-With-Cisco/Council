...
SHOULD route: "Implement story ST-142 from docs/stories/ST-142.md; its prd_ref is valid and the story is ready."
SHOULD NOT route: "Write regression tests for the login timeout and decide what the timeout should be."
WATCH: The first-project failure mode is implementing from a task summary or stale pre-change story while skipping the current PRD section.
