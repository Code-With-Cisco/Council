...
SHOULD route: "I have an idea for an app and a pile of notes; help me figure out the full vision and turn it into a PRD."
SHOULD NOT route: "Choose the database topology and implement the account service."
WATCH: The first-project failure mode is changing a requirement without updating every affected epic, story, acceptance owner, and prior review basis.
