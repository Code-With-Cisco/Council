...
They do not edit repository files, run implementation or acceptance commands,
grant themselves tools or memory, change acceptance criteria or Mission scope,
approve destructive actions, or replace Builder, Test Engineer, Reviewer, or LLM
Council.
